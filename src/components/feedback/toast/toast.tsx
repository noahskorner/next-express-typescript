  ...
  return (
    ...
    >
      <div className="w-full py-5 pl-4 space-y-2 bg-slate-700 rounded">
        <h6 className="font-semibold text-slate-200">{title}</h6>
        {body && <p className="text-slate-500 dark:text-slate-300">{body}</p>}
      </div>
      <div className="p-1">
        <button
          onClick={handleToastClick}
          className="w-6 h-6 rounded-md flex justify-center items-center border-slate-500 hover:bg-slate-600 hover:rotate-90"
        >
          <svg
